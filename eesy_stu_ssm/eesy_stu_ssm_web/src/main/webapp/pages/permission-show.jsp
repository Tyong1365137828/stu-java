        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">"${permission.permissionName}"权限详情------描述：${permission.url}</h3>
                </div>

                <div class="box-body">

                    <form action="${pageContext.request.contextPath}/permission/alter.do"
                          method="post">
                        ...
                        <section class="content"> <!--产品信息-->
                            ...
                            <div class="box-tools text-center">
                                ...
                                <a href="${pageContext.request.contextPath}/permission/findAll.do" class="btn bg-default btn-group-xs">返回</a>
                            </div>
                            <!--工具栏/--> </section>
                        <!-- 正文区域 /-->
                    </form>
