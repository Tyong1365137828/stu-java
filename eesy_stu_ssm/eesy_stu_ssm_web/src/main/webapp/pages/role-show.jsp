        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">"${role.roleName}"角色信息</h3>
                </div>

                <div class="box-body">

                    <form action="${pageContext.request.contextPath}/role/alter.do"
                          method="post">
                        ...
                        <section class="content"> <!--产品信息-->
                            ...
                            <div class="box-tools text-center">
                                ...
                                <a href="${pageContext.request.contextPath}/role/findAll.do" class="btn bg-default btn-group-xs">返回</a>
                            </div>
                            <!--工具栏/--> </section>
                        <!-- 正文区域 /-->
                    </form>
                                ...
                                <c:forEach items="${role.permissions}" var="permission" varStatus="vs1">
                                    <tr data-tt-id="${vs1.index+1}" data-tt-parent-id="0">
                                        ...
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/role/cutPermission.do?roleId=${role.id}&permissionId=${permission.id}" class="btn bg-red btn-xs">移除权限</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
