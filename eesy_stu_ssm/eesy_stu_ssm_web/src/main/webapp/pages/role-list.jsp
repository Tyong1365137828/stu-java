									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/findSingle.do?id=${role.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/role/canAddPermissions.do?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
												<a href="${pageContext.request.contextPath}/role/cut.do?id=${role.id}" class="btn bg-red btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
