...
${user.password }<br>
${user.usename }<br>
<a href="http://127.0.0.1:8080/_servlet_dao_2020_04/servlet/UserExitServlet">注销用户（绝对路径）</a>
<a href="/_servlet_dao_2020_04/servlet/UserExitServlet1">注销（根路径）</a>
...
<a href="/_servlet_dao_2020_04/admin4_path/show.jsp">show.jsp</a><br>
