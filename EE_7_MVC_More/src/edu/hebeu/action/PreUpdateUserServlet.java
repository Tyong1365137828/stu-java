...
/**
 * Servlet implementation class PreUpdateUserServlet
 */
@WebServlet("/myServlet/PreUpdateUserServlet")
public class PreUpdateUserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User user = userService.findUserByNum(userid);
		request.setAttribute("preUpdate_user", user);
