...
public class TeaChangePass implements ActionListener {

	JFrame changepassFrame = new JFrame("教师修改密码界面");
		...
		if (e.getSource() == confirmButton) {
			...
			if (passwordField.getText().length() == 0) {
				...
				try {
					...
					String sql = "select * from teacher where tea_id='" + id + "'" + "and tea_password ='" + password
							+ "'";
					...
					if(count != 0) {
						...
						teacherDaoImpl.UpdateTea(id, repassword);
						
						JOptionPane.showMessageDialog(p2, "'"+id+"'教师，您初始的密码'"+password+"'更改为'" + repassword + "'", "信息提示",
