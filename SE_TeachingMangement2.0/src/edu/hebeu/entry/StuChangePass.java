...
public class StuChangePass implements ActionListener{
	
	JFrame changepassFrame = new JFrame("学生修改密码界面");
		...
		if (e.getSource() == confirmButton) {
			...
			if (passwordField.getText().length() == 0) {
				...
				try {
					...
					String sql = "select * from student where stu_number='" + id + "'" + "and stu_password ='" + password
							+ "'";
					...
					if(count != 0) {
						...
						studentDaoImpl.UpdateStu(id, repassword);
						
						JOptionPane.showMessageDialog(p2, "'"+id+"'同学，您初始的密码'"+password+"'更改为'" + repassword + "'", "信息提示",
