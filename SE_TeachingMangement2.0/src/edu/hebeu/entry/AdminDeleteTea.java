...
public class AdminDeleteTea implements ActionListener{
	...
	JFrame deleteFrame = new JFrame("教师删除界面");
	...
	public AdminDeleteTea() {
		...
		tea_id = new JRadioButton("按id查");
		tea_name = new JRadioButton("按名查");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == deleteButton1) {
			...
			JOptionPane.showMessageDialog(p13, "教师删除成功", "信息提示框", JOptionPane.WARNING_MESSAGE);
		}
		...
		if(e.getSource() == deleteButton) {
			...
			JOptionPane.showMessageDialog(p22, "教师删除成功", "信息提示框", JOptionPane.WARNING_MESSAGE);
		}
