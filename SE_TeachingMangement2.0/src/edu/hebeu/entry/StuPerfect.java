...
public class StuPerfect implements ActionListener{
	...
	JFrame perFrame = new JFrame("学生信息修改与完善");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == confirmButton) {
			if(nameField.getText().length() == 0) {
				...
				JOptionPane.showMessageDialog(p3, "请输入地址", "错误警告", JOptionPane.ERROR_MESSAGE);
			}else {
...
//				student.setStu_depnum(String.valueOf(depnumcomboBox.getSelectedItem()));//获取下拉框的值
				...
				JOptionPane.showMessageDialog(perFrame, "信息修改成功！", "信息提示框", JOptionPane.WARNING_MESSAGE);	
			}
